...
export const technicalCourses = [
  ...
  {
    id: "tc-003",
    title: "Glass Changing Master Program (Updation Program)",
    shortTitle: "GCM",
    category: "Technical",
    duration: "5 Days",
    durationBreakdown: "Intensive practical updation course",
    description:
    ...
    modules_list: [
      ...
      { id: 3, title: "OCA Lamination Process", duration: "10 hrs", completed: false, lessons: 5 },
...
export const managementCourses = [
  ...
  {
    id: "mc-002",
    title: "AI Integrated Sales Management",
    shortTitle: "SM",
    category: "Management",
    duration: "6 Months",
    durationBreakdown: "6 Months full program",
    description:
  ...
  {
    id: "mc-004",
    title: "AI Integrated Hospital Administration & Management Studies",
    shortTitle: "HAM",
    category: "Management",
    duration: "360 Hours",
    durationBreakdown: "240 Hours Institutional + 120 Hours Hospital Internship",
    description:
      "Administrative skills for hospital environments: medical terminology, billing, reception management, and compliance.",
    modules: 9,
    lessonsCount: 36,
    enrolledStudents: 54,
    progress: 0,
  ...
  {
    id: "mc-005",
    title: "AI Integrated Business & Office Administration",
    shortTitle: "BOA",
    category: "Management",
    duration: "240 Hours",
